...
export function PatientCreateModal({ isOpen, onClose, onSuccess }: PatientCreateModalProps) {
  ...
  const onSubmit = async (data: CreatePatientFormValues) => {
    ...
    await createPatient.mutateAsync({
      ...
      therapyFrequency: data.therapyFrequency || undefined,
      therapyDuration: data.therapyDuration || undefined,
      emergencyContact: {
  ...
  return (
    <FormModal
      ...
      title={t('patients.create.title', 'Create New Patient')}
      submitText={t('patients.create.submit', 'Create Patient')}
      isLoading={createPatient.isPending}
      isSubmitDisabled={!isValid || !isDirty || createPatient.isPending}
      size="lg"
    >
